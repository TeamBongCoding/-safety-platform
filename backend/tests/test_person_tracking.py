...
class CameraPersonTrackerTests(unittest.TestCase):
    ...
    def test_motion_restores_ids_after_occlusion_with_similar_appearance(self):
        tracker = CameraPersonTracker()
        tracker._tracker = SequencedBotTracker([
            [
                bot_row([10, 10, 40, 110], 101, 0),
        ...
        self.assertEqual(_center_x(by_id[first_ids[0]].box), 110.0)
        self.assertEqual(_center_x(by_id[first_ids[1]].box), 50.0)
